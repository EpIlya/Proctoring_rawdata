...
The Parser_data folder contains a parser for certain metrics, such as true/false positives, total number of directions, etc.
The main parser program with the most important metrics is called parse_data.
